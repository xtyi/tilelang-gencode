  ...
  if (128 <= ((int)threadIdx.x)) {
    ...
    for (int k = 0; k < 32; ++k) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(A_desc, mbarrier[(k & 1)], (&(((half_t*)buf_dyn_shmem)[((k & 1) * 4096)])), (k * 32), (((int)blockIdx.y) * 128));
        mbarrier[(k & 1)].expect_transaction(8192);
        tl::fence_proxy_async();
        tl::tma_load(B_desc, mbarrier[(k & 1)], (&(((half_t*)buf_dyn_shmem)[(((k & 1) * 4096) + 8192)])), (((int)blockIdx.x) * 128), (k * 32));
        tl::tma_load(B_desc, mbarrier[(k & 1)], (&(((half_t*)buf_dyn_shmem)[(((k & 1) * 4096) + 10240)])), ((((int)blockIdx.x) * 128) + 64), (k * 32));
      }
      mbarrier[(k & 1)].arrive();
    }
  } else {
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      tl::initialize_wgmma_descriptor<2, 1, 32>(desc_a, (&(((half_t*)buf_dyn_shmem)[((k_1 & 1) * 4096)])));
      tl::initialize_wgmma_descriptor<1, 256, 64>(desc_b, (&(((half_t*)buf_dyn_shmem)[(((k_1 & 1) * 4096) + 8192)])));
