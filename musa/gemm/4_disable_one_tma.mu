  ...
  if ((((int)threadIdx.x) < 128)) {
    ...
    for (int ko_1 = 0; ko_1 < 32; ++ko_1) {
      ...
      for (int i_1 = 0; i_1 < 4; ++i_1) {
        tl::cp_async_gs<16>((&(((half_t*)buf_dyn_shmem)[((((((ko_1 & 1) * 4096) + (i_1 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) & 15) >> 1) ^ (((int)threadIdx.x) >> 4)) * 16)) + ((((int)threadIdx.x) & 1) * 8))])), (&(B[(((((ko_1 * 32768) + (i_1 * 8192)) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)blockIdx.x) * 128)) + ((((int)threadIdx.x) & 15) * 8))])));
      }
      tl::cp_async_commit();
      tl::cp_async_wait<0>();
